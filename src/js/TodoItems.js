              ...
              return(
                <li key={key}>
                  ...
                  {this.state.editableListItem === key
                    ? <div className="pull-left editInputBox" >
                        <input type="text" ref={'item' + key} defaultValue={data.text} />
                        <FontIcon onClick={this.updateListItem.bind(this, data, key)} color={blue500}
                          className="material-icons iconBtns">save</FontIcon>
                      </div>
                    : <div className="pull-left">
                        <span className="pull-left listName">{data.text}</span>
                        <FontIcon onClick={this.editListItem.bind(this, data, key)} color={blue500}
                          className="material-icons iconBtns">edit</FontIcon>
                      </div>
                  }
                  <FontIcon onClick={this.handleDelete.bind(this, data)} color={deepOrangeA400}
